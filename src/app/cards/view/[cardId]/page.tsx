...
export default function CardViewerPage() {
  ...
  return (
    <div className={`flex flex-col items-center min-h-screen px-4 py-6 ${stage === "letter" ? "justify-start" : "justify-center"}`} style={{ background: "var(--color-cream)" }}>
      <style>{`
            ...
            {hasLetter ? (
              ...
              <>
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-xs text-warm-gray text-center mt-1">Created by Nuuge</p>
                </div>
                ...
                <div className="flex items-center justify-center gap-3 mt-4">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-4 py-1.5 rounded-full text-sm text-warm-gray hover:text-charcoal transition-colors flex-shrink-0"
                    style={{ border: "1.5px solid var(--color-sage)" }}
                  >
                  ...
                  {shareUrl && (
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-full flex-1 max-w-xs" style={{ background: "var(--color-brand-light)", border: "1px solid var(--color-sage)" }}>
                      <input
                        readOnly
                        value={shareUrl}
                        className="flex-1 text-xs bg-transparent outline-none text-charcoal min-w-0"
      ...
      {stage === "letter" && (
        <div className="card-fade-in flex flex-col w-full max-w-xl">
          <div
            className="letter-fall overflow-y-auto rounded-xl"
            style={{
              background: "#fefcf8",
